            ...
            Grid {
                ...
                Component.onCompleted: {
                    ...
                    for (var i = 0; i < 9; ++i) {
                        var row = [];
                        for (var j = 0; j < 9; ++j) {
                            var sudokuTextField = Qt.createComponent("qrc:/qt/qml/SudokuVS/SudokuTextField.qml").createObject(sudokuGrid, {
                                "index": i * 9 + j,
...
//                     font.pixelSize: 16 // Adjust font size as needed
//                     color: "white"
//                     Layout.alignment: Qt.AlignLeft // Center the text horizontally
//                 }

//                 Button {
//                     text: "Back"
//                     onClicked: backClicked()
//                     Layout.alignment: Qt.AlignRight // Center the button horizontally
